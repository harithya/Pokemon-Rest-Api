      ...
      for (let i = 0; i < this.__pokemons__.length; i++) {
        ...
        for (const key in variation) {
          if (
            ...
            pokemon.image = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${this.__pokemons__[i].num}.png`;
            pokemon.type = variation.types;
  ...
  mapListPokemon(pokemons) {
    return pokemons.map(pokemon => {
      return {
        num: pokemon.num,
        name: pokemon.name,
        image: `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${pokemon.num}.png`,
        type: pokemon.variations[0].types
      };
    });
  }
};
